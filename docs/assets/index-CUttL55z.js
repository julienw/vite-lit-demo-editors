...
let StringEditor = class extends i {
  onInput(event) {
...
], StringEditor.prototype, "value", 2);
StringEditor = __decorateClass([
  t("string-editor")
], StringEditor);
let ObjectEditor = class extends i {
  onInput(event) {
    const target = event.target;
    try {
...
], ObjectEditor.prototype, "value", 2);
ObjectEditor = __decorateClass([
  t("object-editor")
], ObjectEditor);
let DemoEditors = class extends i {
  constructor() {
    super(...arguments);
  ...
  onObjectChanged() {
    this.objectModified = JSON.stringify(this.objectEditor.value) !== JSON.stringify(this.initialObjectValue);
  }
  render() {
    return x`
      <div class="demo-container">
        ...
        <div class="editor-with-badge">
          ...
          ></string-editor>
          ${this.stringModified ? x`<span class="modified-badge">modified</span>` : ""}
        </div>
        ...
        <div class="editor-with-badge">
          ...
          ></object-editor>
          ${this.objectModified ? x`<span class="modified-badge">modified</span>` : ""}
        </div>
      </div>
    `;
  }
};
DemoEditors.styles = i$3`
    .demo-container {
      max-width: 800px;
      margin: 0 auto;
      padding: 20px;
...
__decorateClass([
  r()
], DemoEditors.prototype, "stringModified", 2);
__decorateClass([
  r()
], DemoEditors.prototype, "objectModified", 2);
__decorateClass([
  e("string-editor")
], DemoEditors.prototype, "stringEditor", 2);
__decorateClass([
  e("object-editor")
], DemoEditors.prototype, "objectEditor", 2);
DemoEditors = __decorateClass([
  t("demo-editors")
], DemoEditors);
//# sourceMappingURL=index-CUttL55z.js.map
